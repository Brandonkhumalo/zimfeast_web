...
// node_modules/react-cool-onclickoutside/dist/index.esm.js
...
var checkClass = function checkClass2(el, cl) {
  var _el$classList;
  return (_el$classList = el.classList) == null ? void 0 : _el$classList.contains(cl);
};
var hasIgnoreClass = function hasIgnoreClass2(e, ignoreClass) {
  var el = e.target || e;
  while (el) {
...
var clickedOnScrollbar = function clickedOnScrollbar2(e) {
  return document.documentElement.clientWidth <= e.clientX || document.documentElement.clientHeight <= e.clientY;
};
var getEventOptions = function getEventOptions2(type) {
  return type.includes("touch") && canUsePassiveEvents() ? {
    passive: true
  } : false;
};
var useOnclickOutside = function useOnclickOutside2(callback, _temp) {
  var _ref = _temp === void 0 ? {} : _temp, refsOpt = _ref.refs, disabled = _ref.disabled, _ref$eventTypes = _ref.eventTypes, eventTypes = _ref$eventTypes === void 0 ? ["mousedown", "touchstart"] : _ref$eventTypes, excludeScrollbar = _ref.excludeScrollbar, _ref$ignoreClass = _ref.ignoreClass, ignoreClass = _ref$ignoreClass === void 0 ? DEFAULT_IGNORE_CLASS : _ref$ignoreClass, _ref$detectIFrame = _ref.detectIFrame, detectIFrame = _ref$detectIFrame === void 0 ? true : _ref$detectIFrame;
  var _useState = (0, import_react.useState)([]), refsState = _useState[0], setRefsState = _useState[1];
  var callbackRef = (0, import_react.useRef)(callback);
  callbackRef.current = callback;
  var ref = (0, import_react.useCallback)(function(el) {
  ...
  (0, import_react.useEffect)(
    function() {
      ...
      var blurHandler = function blurHandler2(e) {
        return (
...
var index_esm_default = useOnclickOutside;
export {
  DEFAULT_IGNORE_CLASS,
  index_esm_default as default
};
//# sourceMappingURL=react-cool-onclickoutside.js.map
